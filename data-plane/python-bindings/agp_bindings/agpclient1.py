...
async def run_client(
    ...
    # Configure gateway
    config = GatewayConfig(endpoint=address, insecure=True) # i think endpoint here can be any public url say on ec2
    gateway.configure(config)

    # Connect to the gateway server  (## optional: I think of this as agent registration with remote ec2 hosted gateway server)
